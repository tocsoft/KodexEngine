...
{
    public class KodexModuleContentController : ApiController
    {
        [HttpGet]
        public HttpResponseMessage File(string plugin, Plugin.ContentAreas contentArea, string path)
        {
            ...
            else
            {
                ...
                result.Content = new StreamContent(file.OpenStream());
                result.Content.Headers.ContentType =
                    new MediaTypeHeaderValue(MimeTypeMap.GetMimeType(file.Extension));
                return result;
            }
        }
